...
public class DandelionTextSimilarityService implements TextSimilarityService {
	private static final Logger logger = LoggerFactory.getLogger(DandelionTextSimilarityService.class);
